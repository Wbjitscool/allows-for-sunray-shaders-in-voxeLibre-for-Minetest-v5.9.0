How to use copy this mod into the location of where VoxeLibre is here's an exambple once you go into minetest folder then click on games then go into VoxeLibre then
